...
@onready var v_box_container: VBoxContainer = $ExerciseList/MarginContainer/VBoxContainer
@onready var selected_exercise_pane: Panel = $SelectedExercise/MarginContainer/Panel
